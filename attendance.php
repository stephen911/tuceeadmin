                ...
                <div class="container-fluid page__container p-0">
                    <div class="row m-0">
                        <div class="col-lg container-fluid page__container">
                            ...
                            <h1 class="h2">Upload Attendance</h1>
                            ...
                            <div class="container">
                                <form action="uploadatt.php" method="post" enctype="multipart/form-data">
                            ...
                            <!-- <div class="page-nav__content">
                                    <button type="submit" name="btnupdate" class="btn btn-success">Upload Attendance</button>
                                </div> -->
                            ...
                            <div data-perfect-scrollbar>
                                <div class="page-section pt-lg-32pt">
                                    <ul class="nav page-nav__menu">
                                        <li class="nav-item">
                                            <a href="#" class="nav-link active">Upload Attendance </a>
                                        </li>
