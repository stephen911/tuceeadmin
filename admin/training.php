...
<head>
    ...
    <title>Set User Training Date</title>
                    ...
                    <div class="row m-0">
                        <div class="col-lg container-fluid page__container">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Set Training Date </li>
                            </ol>
                            ...
                            <h1 class="h2">Set Training Date</h1>
                            ...
                            <form action="" method="POST" class="settdate">
                                ...
                                <div class="page-nav__content">
                                    <button type="submit" name="btnupdate" class="btn btn-success">Update District Training Date</button>
                                </div>
                            ...
                            <div data-perfect-scrollbar>
                                <div class="page-section pt-lg-32pt">
                                    <ul class="nav page-nav__menu">
                                        <li class="nav-item">
                                            <a href="#" class="nav-link active">Set Training Date </a>
                                        </li>
