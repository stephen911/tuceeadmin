                        ...
                        <div class="card-body">
                            <div class="media flex-wrap align-items-center">
                                ...
                                <div class="media-body" style="min-width: 180px">
                                    Your are welcome Admin! <strong><?php echo $user1['name']; ?></strong>
                                </div>
                            ...
                            <!-- <div class="list-group list-group-fit">
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-status">
                                        <div class="form-row">
                                            <label id="label-status" for="status" class="col-md-3 col-form-label form-label">Show District Quiz
                                            </label>
                                            <div class="col-md-9">
                                                <select id="custom-select" class="form-control custom-select" name="disquiz">
                                                    <option selected value="<?php echo ($user['quiz'] == '') ? '' : $user['quiz']; ?>"><?php echo ($user['quiz'] == '') ? '' : $user['quiz']; ?></option>
                    ...
                    <div class="card">
                        ...
                        <ul class="list-group list-group-fit mb-0">
                            ...
                            <li class="list-group-item">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <a class="text-body" href="#"><strong>Jollof and chicken(All)</strong></a><br>
                                        <!-- <div class="d-flex align-items-center">
                                            <small class="text-black-50 text-uppercase mr-2">Course</small>
                                            <a href="student-take-course.html">Angular in Steps</a>
                                        </div> -->
                                    ...
                                    <div class="media-right text-center d-flex align-items-center">
                                        ...
                                        <?php
                                        if (isset($_POST['btnupdate'])) {
                                            foodstats($_POST['district']);
                                        } else {
                                            echo '<h4 class="mb-0 text-success">0</h4>';
                                        }
                            ...
                            <li class="list-group-item">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <a class="text-body" href="#"><strong>Jollof and chicken(Paid)</strong></a><br>
                                        <!-- <div class="d-flex align-items-center">
                                            <small class="text-black-50 text-uppercase mr-2">Course</small>
                                            <a href="student-take-course.html">Angular in Steps</a>
                                        </div> -->
                            ...
                            <li class="list-group-item">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <a class="text-body" href="#"><strong>Jollof and chicken(Confirmed)</strong></a><br>
                                        <!-- <div class="d-flex align-items-center">
                                            <small class="text-black-50 text-uppercase mr-2">Course</small>
                                            <a href="student-take-course.html">Angular in Steps</a>
                                        </div> -->
