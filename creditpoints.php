...
<head>
    ...
    <title>Upload Credit Points</title>
                    ...
                    <div class="row m-0">
                        <div class="col-lg container-fluid page__container">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Upload Credit points </li>
                            </ol>
                            ...
                            <h1 class="h2">Upload Credit points</h1>
                            ...
                            <!-- <div class="page-nav__content">
                                    <button type="submit" name="btnupdate" class="btn btn-success">upload credit points</button>
                                </div> -->
                            ...
                            <div data-perfect-scrollbar>
                                <div class="page-section pt-lg-32pt">
                                    <ul class="nav page-nav__menu">
                                        <li class="nav-item">
                                            <a href="#" class="nav-link active">Upload Credit points </a>
                                        </li>
